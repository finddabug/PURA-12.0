...
Only requiring some minor changes is PURA.cpp.
...
Changes to PURA.cpp
----------------------
PURA.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
