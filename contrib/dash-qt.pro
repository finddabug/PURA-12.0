...
RESOURCES += src/qt/PURA.qrc src/qt/PURA_locale.qrc
TRANSLATIONS += src/qt/locale/PURA_bg.ts \
                src/qt/locale/PURA_de.ts \
                src/qt/locale/PURA_en.ts \
                src/qt/locale/PURA_es.ts \
                src/qt/locale/PURA_fi.ts \
                src/qt/locale/PURA_fr.ts \
                src/qt/locale/PURA_it.ts \
                src/qt/locale/PURA_ja.ts \
                src/qt/locale/PURA_pl.ts \
                src/qt/locale/PURA_pt.ts \
                src/qt/locale/PURA_ru.ts \
                src/qt/locale/PURA_sk.ts \
                src/qt/locale/PURA_sv.ts \
                src/qt/locale/PURA_vi.ts \
                src/qt/locale/PURA_zh_CN.ts \
                src/qt/locale/PURA_zh_TW.ts
