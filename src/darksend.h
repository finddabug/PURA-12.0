...
{
public:
    /// Is the inputs associated with this public key? (and there is 100000 PURA - checking if valid masternode)
...
public:
    ...
    /// Get the denominations for a specific amount of PURA.
