    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("PURA Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About PURA Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  PURA-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("PURA Core is shutting down...") + "<br /><br />" +
