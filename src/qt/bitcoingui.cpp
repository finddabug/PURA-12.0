    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("PURA Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a PURA address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and PURA: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About PURA Core"), this);
    aboutAction->setStatusTip(tr("Show information about PURA Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for PURA"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your PURA addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified PURA addresses"));
    ...
    openAction->setStatusTip(tr("Open a PURA: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the PURA Core help message to get a list with possible PURA command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("PURA Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to PURA network", "", count));
}
...
{
    QString strTitle = tr("PURA Core"); // default title
