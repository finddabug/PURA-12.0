...
static Checkpoints::MapCheckpoints mapCheckpoints =
        ...
        ( 0, uint256("0x00000feb775ad4d6bd60b76db8bd4a0f795ac6977f6a8b831256daa06d95ce73"))
        ;
static const Checkpoints::CCheckpointData data = {
        &mapCheckpoints,
        1499483453, // * UNIX timestamp of last checkpoint block
...
static Checkpoints::MapCheckpoints mapCheckpointsTestnet =
        boost::assign::map_list_of
        ( 0, uint256("0x000001c6bfdd665e15ff91968b2c6f6086042284de89938030b372f73957fefe"))
        ;
...
static Checkpoints::MapCheckpoints mapCheckpointsRegtest =
        boost::assign::map_list_of
        ( 0, uint256("0x00000b460b0d50ddb57851972b9701ac4aab73e2070708c6daaafebc36cbf495"))
        ;
...
public:
    CMainParams() {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("040184710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa111ce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime    = 1499483453;
        genesis.nBits    = 0x1e0ffff0;
        genesis.nNonce   = 3322426;
...
public:
    CTestNetParams() {
        ...
        vAlertPubKey = ParseHex("040184710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa111ce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9");
        nDefaultPort = 19999;
        ...
        genesis.nTime = 1500000000;
        genesis.nNonce = 3677605;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x000001c6bfdd665e15ff91968b2c6f6086042284de89938030b372f73957fefe"));
