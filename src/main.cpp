...
#if defined(NDEBUG)
# error "PURA cannot be compiled without assertions."
#endif
...
//static const int64_t nStartSubsidy = 25.16 * COIN;
//static const int64_t nMinSubsidy = 25 * COIN;
...
int64_t GetBlockValue(int nBits, int nHeight, const CAmount& nFees)
{
    ...
    if(nHeight == 0)
    {
        nSubsidy = 224100000 * COIN;
    }
    else if (nHeight < 50000000 && nHeight > 0)
    {
        nSubsidy = 25.16 * COIN;
    }
