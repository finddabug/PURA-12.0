/* src/config/PURA-config.h.  Generated from PURA-config.h.in by configure.  */
/* src/config/PURA-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef PURA_CONFIG_H

#define PURA_CONFIG_H
...
#define PACKAGE_BUGREPORT "info@PURA.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "PURA Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "PURA Core 0.12.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "PURA"
