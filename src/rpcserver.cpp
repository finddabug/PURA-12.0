...
{ //  category              name                      actor (function)         okSafeMode threadSafe reqWallet
  //  --------------------- ------------------------  -----------------------  ---------- ---------- ---------
    ...
    /* PURA features */
    { "PURA",               "masternode",             &masternode,             true,      true,       false },
    { "PURA",               "masternodelist",         &masternodelist,         true,      true,       false },
    { "PURA",               "masternodebroadcast",    &masternodebroadcast,    true,      true,       false },
    { "PURA",               "mnbudget",               &mnbudget,               true,      true,       false },
    { "PURA",               "mnbudgetvoteraw",        &mnbudgetvoteraw,        true,      true,       false },
    { "PURA",               "mnfinalbudget",          &mnfinalbudget,          true,      true,       false },
    { "PURA",               "mnsync",                 &mnsync,                 true,      true,       false },
    { "PURA",               "spork",                  &spork,                  true,      true,       false },
#ifdef ENABLE_WALLET
    { "PURA",               "darksend",               &darksend,               false,     false,      true  }, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
         ...
         (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"])) && Params().RequireRPCPassword())
    {
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
            _("To use PURAd, or the -server option to PURA-qt, you must set an rpcpassword in the configuration file:\n"
              "%s\n"
